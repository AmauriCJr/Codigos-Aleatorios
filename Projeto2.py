...
#Lê o conteúdo dos arquivos .txt contidos nas pastas enviadas como argumento.
...
#Recebe uma lista de strings e transforma em uma lista de floats
...
#Funçaõ feita em sala que realiza a divisão do sinal em bandas de energia
...
#Cria um vetor do tamanho do número de pacientes com as labels recebidas
...
#Realiza a fft e divisão em bandas de energia em cada uma das linhas da lista 
...
#Concatena os dois arrays de dados que serão usados no treinamento
...
# cria o set de treinamento e de teste de acordo com as duas opções enviadas
...
#Cria os caminhos para os arquivos com os dados de EEG
def Open_EEG():
...
if __name__ == '__main__':
    ...
    #Realiza a "normalização" dos dados, botando todos dentro de um mesmo limite de valores
    sc = StandardScaler()
